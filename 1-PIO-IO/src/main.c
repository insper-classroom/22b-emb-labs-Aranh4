...
int main(void)
{
  ...
  while (1)
  {
	  int but1info = pio_get(BUT1_PIO, PIO_INPUT, BUT1_PIO_IDX_MASK);
	  int but2info = pio_get(BUT2_PIO, PIO_INPUT, BUT2_PIO_IDX_MASK);
	  int but3info = pio_get(BUT3_PIO, PIO_INPUT, BUT3_PIO_IDX_MASK);
